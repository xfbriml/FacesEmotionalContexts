...
%%
%todos os eletrodos  Hits vs CR    Diferença sig todas as epochs
figure;
        subplot(3,6,1)
        ...
        title('P8')
            ...
            legend('Old','New')
%%
%todos os eletrodos Neutral Hits vs CR    Diferença sig entre 200-300,
%300-500 e 800-1100

figure;
        subplot(3,6,1)
        plot(time_vector,F7_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,F7_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('F7')
        subplot(3,6,2)
        plot(time_vector,F3_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,F3_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('F3')
        subplot(3,6,3)
        plot(time_vector,F4_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,F4_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('F4')
        subplot(3,6,4)
        plot(time_vector,F8_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,F8_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('F8')
        subplot(3,6,5)
        plot(time_vector,C3_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,C3_new, 'Linewidth',1, 'Color','k')
        hold on
        axis off
        ...
        title('C3')
        subplot(3,6,6)
        plot(time_vector,FC1_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,FC1_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('FC1')
        subplot(3,6,7)
        plot(time_vector,FC2_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,FC2_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('FC2')
        subplot(3,6,8)
        plot(time_vector,C4_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,C4_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('C4')
        subplot(3,6,9)
        plot(time_vector,T7_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,T7_new, 'Linewidth',1, 'Color','k')
        hold on
        axis off
        ...
        subplot(3,6,10)
        plot(time_vector,FC5_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,FC5_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('FC5')
        subplot(3,6,11)
        plot(time_vector,FC6_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,FC6_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('FC6')
        subplot(3,6,12)
        plot(time_vector,T8_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,T8_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('P3')
        subplot(3,6,14)
        plot(time_vector,CP1_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,CP1_new, 'Linewidth',1, 'Color','k')
        hold on
        axis off
        ...
        title('CP1')
        subplot(3,6,15)
        plot(time_vector,CP2_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,CP2_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('P4')
        subplot(3,6,17)
        plot(time_vector,P7_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,P7_new, 'Linewidth',1, 'Color','k')
        hold on
        ...
        title('P7')
        subplot(3,6,18)
        plot(time_vector,P8_neu, 'Linewidth',2, 'Color','k')
        hold on
        plot(time_vector,P8_new, 'Linewidth',1, 'Color','k')
        hold on
...
%%
%todos os eletrodos Emo vs CR 200-300, 300-500 e 800-1100
...
%%
% todos os elecs All Hits vs CR sig 200-300
...
figure;
        ...
        title('P8')
            ...
            legend('Negative','Positive','Neutral','New')