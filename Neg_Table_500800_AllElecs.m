...
dataSelected_NEG500_800 = data_Electrodes_NEG(:,151:225);
...
for col=1:size(dataSelected_NEG500_800,2)
    coluna = dataSelected_NEG500_800(:, col)
    start = first
    finish = first+29
