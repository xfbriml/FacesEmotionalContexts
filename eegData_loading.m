...
%
%ROIs
dataROIval_neg = [F3; FC1; F4; FC2];
dataROILPP_neg = [CP5; CP1; P3; C3]
dataROIfrontal_neg = [F3; Fz]
dataROIN170_neg = [P7; P8; T7; T8]
dataROIN250_neg = [FC1; C3; FC2; C4]
%%
%% Initialize variables.
...
%
%ROIs
dataROILPP_neu = [CP5; CP1; P3; C3]
dataROIfrontal_neu = [F3; Fz]
dataROIN170_neu = [P7; P8; T7; T8]
dataROIN250_neu = [FC1; C3; FC2; C4]
%%
%% Initialize variables.
...
%
%ROIs
dataROIval_pos = [F3; FC1; F4; FC2];
dataROILPP_pos = [CP5; CP1; P3; C3]
dataROIfrontal_pos = [F3; Fz]
dataROIN170_pos = [P7; P8; T7; T8]
dataROIN250_pos = [FC1; C3; FC2; C4]
%emo elec
...
%
%ROIs
dataROILPP_emo = [CP5; CP1; P3; C3]
dataROIfrontal_emo = [F3; Fz]
dataROIN170_emo = [P7; P8; T7; T8]
dataROIN250_emo = [FC1; C3; FC2; C4]

meanROIparietal_emo = mean(dataROILPP_emo);
meanROIparietal_neg = mean(dataROILPP_neg);
meanROIparietal_neu = mean(dataROILPP_neu);
meanROIparietal_new = mean(dataROILPP_new);
meanROIparietal_old = mean(dataROILPP_old);
meanROIparietal_pos = mean(dataROILPP_pos);


meanROIfrontal_emo = mean(dataROIfrontal_emo);
...
meanROIN170_emo = mean(dataROIN170_emo);
...
meanROIN250_emo = mean(dataROIN250_emo);
