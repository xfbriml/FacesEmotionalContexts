...
AFz = G(30,:);
%need code 
data_selectedElectrodes_Neg = [Fp1; F3; F4; Fp2; F7; F8];
%
%
GN250 = G(:, 84:106);

%data that should be copied into the table
dataSelected_NegN250 = data_selectedElectrodes_Neg(:, 84:106);
...
for col=1:size(dataSelected_NegN250,2)
    coluna = dataSelected_NegN250(:, col)
    start = first
    finish = first+5
