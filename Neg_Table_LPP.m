...
AFz = G(30,:);
%need code 
data_selectedElectrodes_Neg = [P3; C3; CP1; CP5];
%
%
GLPP = G(:, 201:300);

%data that should be copied into the table
dataSelected_NegLPP = data_selectedElectrodes_Neg(:, 201:300);
...
for col=1:size(dataSelected_NegLPP,2)
    coluna = dataSelected_NegLPP(:, col)
    start = first
    finish = first + 3
