...
AFz = G(30,:);
%need code 
data_selectedElectrodes_Neg = [CP2; FC2; FC6];
%
%
GFN400 = G(:,151:226);

%data that should be copied into the table
dataSelected_NegFN400 = data_selectedElectrodes_Neg(:,151:226);
...
for col=1:size(dataSelected_NegFN400,2)
    coluna = dataSelected_NegFN400(:, col)
    start = first
    finish = first+2
