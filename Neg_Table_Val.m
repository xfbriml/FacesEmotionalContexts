...
AFz = G(30,:);
%need code 
data_selectedElectrodes_Neg = [F3; FC5; FC1; F4; FC6; FC2];
%
%
GVal = G(:, 151:226);

%data that should be copied into the table
dataSelected_NegVal = data_selectedElectrodes_Neg(:, 151:226);
...
for col=1:size(dataSelected_NegVal,2)
    coluna = dataSelected_NegVal(:, col)
    start = first
    finish = first+5
