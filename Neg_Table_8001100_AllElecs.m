...
AFz = G(30,:);
%need code 
data_Electrodes_NEG = [Fp1; Fz; F3; F7; FT9 ; FC5; FC1; C3; T7; CP5; CP1; Pz; P3; P7; O1; Oz; O2 ; P4; P8; CP6; CP2; C4; T8; FT10; FC6; FC2; F4; F8; Fp2; AFz];
%
%
%%G800_1100 = G(:,226:300);

%data that should be copied into the table
dataSelected_NEG800_1100 = data_Electrodes_NEG(:,226:300);
