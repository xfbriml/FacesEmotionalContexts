...
dataSelected_NEG300_500 = data_Electrodes_NEG(:,101:150);
...
for col=1:size(dataSelected_NEG300_500,2)
    coluna = dataSelected_NEG300_500(:, col)
    start = first
    finish = first+29
